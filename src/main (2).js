...
var MainApp = new Vue({
    ...
    methods: {
        fetchConfig: function() {
                ...
                this.axios.get('http://'+self.$root.uri.debug+'/config.json', {timeout: 1000}).then(
                                (response) => {
        ...
        saveConfig: function() {
            console.log(this.config);
                ...
                this.axios.post('http://'+self.$root.uri.debug+'/config', dataF, {timeout: 1000, headers: { 'Content-Type': 'multipart/form-data' }}).then(
                    (response) => {
                        console.log(response);
                    })
                .catch(
